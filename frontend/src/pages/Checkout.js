...
export default function Checkout() {
  ...
  const totalAmount = items.reduce((amount,item)=>(
    discountedPrice(item) * item.quantity + amount
  ),0)
    ...
    return (
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-5">
                      ...
                      handleSubmit((data)=>{
                        ...
                        <div className="space-y-12">
                            <div className="border-b border-gray-900/10 pb-12">
                                ...
                                <p className="mt-1 text-sm leading-6 text-gray-600">Use a permanent address where you can receive shipment.</p>
                ...
                <div className="mt-12 mx-auto max-w-7xl px-0 sm:px-0 lg:px-0 bg-white">
        <div className="px-4 py-12 sm:px-6">
        <h1 className="text-4xl font-bold mb-12 tracking-tight text-gray-900">Cart</h1>
                              ...
                              <li key={item.id} className="flex py-6">
                                ...
                                <div className="ml-4 flex flex-1 flex-col">
                                  ...
                                  <div className="flex flex-1 items-end justify-between text-sm">
                                    ...
                                    <label htmlFor="quantity" className="inline text-sm mr-5 font-medium leading-6 text-gray-900">Qty</label>
